    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#050505', padding: '2rem' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <h1 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#fff' }}>Welcome back</h1>
          <p style={{ color: '#555', marginTop: '0.5rem' }}>Enter your credentials to access your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input 
                ...
                style={{ width: '100%', background: '#111', border: '1px solid #222', borderRadius: '12px', padding: '1rem 1rem 1rem 3rem', color: '#fff', fontSize: '1rem', outline: 'none', transition: 'border-color 0.2s' }}
              />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingRight: '4px' }}>
              ...
              <Link href="#" style={{ color: '#4ade80', fontSize: '0.8rem', textDecoration: 'none' }}>Forgot password?</Link>
            </div>
            <div style={{ position: 'relative' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: '#555', fontSize: '0.95rem' }}>
          Don't have an account? <Link href="/signup" style={{ color: '#fff', fontWeight: 600, textDecoration: 'none' }}>Sign up for free</Link>
        </p>
      </motion.div>
